...
const inApp = pathname =>
  ["themes", "dashboard", "settings"].some(r => pathname.match(new RegExp(r)));
...
class App extends React.Component {
  ...
  render() {
    ...
    const marginUnderPageAdmin = !this.props.location.pathname.match(
      /dashboard/
    );
    return <Switcher />;
    ...
    return (
      <MarketingContainer
        loggedIn={!!user}
        onHomepage={onHomepage(this.props.location.pathname)}
