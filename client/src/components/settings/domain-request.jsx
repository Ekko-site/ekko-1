  ...
  if (dnsRequested) {
    return (
      <p className="mini faded">
        We've begun the process of adding your domain to your Ekko
        website...we'll be in touch shortly!
      </p>
    );
  }
  return (
    <div className="dash-domain">
      ...
      <form
        ...
        <label className="mini faded" for="registrar-input">
          If you know who you registered the domain with, enter it here. If you
