...
const initialState = {
    ...
    fbInfo: {},
    direct_debit_initiating: false,
    completing_direct_debit: false,
    upgrade_error: {},
    upgrading: false,
...
export default function authState(state = initialState, action) {
    switch (action.type) {
        ...
        case DIRECT_DEBIT_INIT:
            return Object.assign({}, state, {
                direct_debit_initiating: true
            })
        case COMPLETING_DIRECT_DEBIT_INIT:
            return Object.assign({}, state, {
                completing_direct_debit: true
            })
        case UPGRADING:
            return Object.assign({}, state, {
                upgrading: true
