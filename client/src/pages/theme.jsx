        ...
        <div className="grid">
          <div className="grid__item palm--one-whole">
            <p className="no-mb progress-list">
              <Link to="/themes" className="progress-list__current">
                Themes
              </Link>
            ...
            {!isCurrentTheme && (
              <p
                className="big-mb"
                onClick={() => this.installTheme(page.id, theme.id)}>
                <span className="butt butt--yellow"> Activate this theme </span>
              </p>
            )}
            <h3 className="big-mb"> A preview of this theme </h3>
            <iframe className="preview-iframe" src={pageUrl} />
          </div>
        </div>
      </div>
    );
