            ...
            <div className="grid__item big-mb one-whole desk--one-half push--desk--one-quarter">
              ...
              <Form
                ...
                <label htmlFor="signUp.password">
                  Choose a password{" "}
                  <span className="note">— minimum 6 characters</span>
                </label>
                <Control.password
                ...
                <div className="big-mb">
                  <p>
                    By continuing, you agree to Ekko's{" "}
            ...
            <div className="grid">
              <div className="grid__item one-whole desk--two-thirds push--desk--one-sixth">
                <blockquote className="large-quote center">
                  "Ekko's really sped up website and content management for my
                  businesses, and they look better than designs I would've had
                  to spend weeks on"
                </blockquote>
                <p className="mini center">
                  <img
                    src={testimonialDuaneImage}
