            ...
            <div className="grid__item one-whole desk--five-sixths push--desk--one-twelfth">
              <h1 className="headline center home-intro__headline">
                ...
                <p className="main-cta animated-faster no-mb">
                  ...
                  <a className="butt butt--big butt--yellow" href="#learn-more">
                    Learn more
                  </a>
                </p>
              </h1>
                  ...
                  <li className="home-extended-intro__flow__final">
                    <div className="grid cf">
                      ...
                      <div className="grid__item five-sixths">
                        <div className="home-extended-intro__flow__text">
                          <p className="no-mb">
                            Your site is instantly updated to reflect your
                            Facebook Page's content. You don't need to do
                            anything!
                          </p>
                        </div>
                      </div>
                ...
                <div className="pricing__copy-content">
                  ...
                  <div className="faded--opacity mini big-mb">
                    ...
                    <p className="mini discount">
                      We offer a{" "}
                      <span className="bold">25% discount for life</span> for
                      non-profit organisations, charities and students. <br />
                      <a href="mailto:hello@ekko.site">Contact us</a> to get set
                      up.
                    </p>
                  </div>
                </div>
